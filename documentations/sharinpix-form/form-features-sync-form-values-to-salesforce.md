...
1. Open the [**SharinPix Form Template Editor**](sharinpix-form-template-editor.md) for the relevant Form Template.
...
**Alert**\
\
The synchronization of Form Responses with parent record fields will only function if the response contains a ParentRecordId. For instance, when a response is submitted through a [**Form Launcher LWC**](../lightning-web-component/sharinpix-form-launcher.md) on an Account record, the ParentRecordId will be set to the Account's record ID.
{% endhint %}
...
<figure><img src="../.gitbook/assets/DOC SF - 1920 x 1080 (13) (2) (1).png" alt=""><figcaption></figcaption></figure>
