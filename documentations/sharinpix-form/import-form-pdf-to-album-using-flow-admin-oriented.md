...
{% hint style="info" %}
The `ImportFormPdfAutomation` Invocable Apex method allows users to automatically import a PDF generated from a SharinPix Form Response into a designated [SharinPix Album Component](/broken/spaces/Hhhsz8OAg6xcF0k0DJhg/pages/LWOdV9eWz0NXM3QUjTmP). This can be used across various business scenarios where form submissions must be archived and associated with a record (e.g., sites, cases, inspections).
...
* A form template has been created using the [SharinPix Form Template Editor](sharinpix-form-template-editor.md) and has been set up using the [SharinPix Form Launcher](/broken/spaces/Hhhsz8OAg6xcF0k0DJhg/pages/Nt8NRMnhV6xJ29Cqi1dY).
{% endhint %}

{% hint style="danger" %}
Large-scale import volumes can trigger internal safety limits, resulting in a temporary block for your organization. The import feature is intended for individual or small-volume imports. [Contact the support team](../getting-started-with-sharinpix/how-to-contact-support.md) for any questions or assistance.
{% endhint %}
...
![](<../.gitbook/assets/Click on the (12) (2) (2).png>)

![](<../.gitbook/assets/Form Response PDF Content Doc (8).png>)
...
![](<../.gitbook/assets/Click on the (14) (1) (1) (1).png>)
...
![](<../.gitbook/assets/Click on the (15) (1) (1) (1).png>)
