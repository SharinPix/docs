...
* The **Work Order** object has a custom field named **SharinPix\_Form\_Token\_\_c** that holds a form token. If you haven't implemented this yet, refer to the article [SharinPix automatic form token generation](automatic-form-token-generation-using-flow-admin-oriented.md) to generate the form token.
{% endhint %}
...
<mark style="color:$danger;">`https://app.sharinpix.com/native_app/form?token=`</mark><mark style="color:$danger;">**`<sharinpix-form-token>`**</mark>
...
* [Context Parameters](https://github.com/SharinPix/documentation/blob/main/documentations/sharinpix-form/sharinpix-forms-context-parameters.md)
...
1. **Set up in Form Builder**\
   The [prefill configuration must first be defined within the **SharinPix Form Builder**](form-features-default-or-prefill-values.md).
...
**Info:**\
\
For more information on the Prefill Feature, please follow the article below: [**Default or Prefill Values**](form-features-default-or-prefill-values.md)
{% endhint %}
...
| <mark style="color:$danger;">`poselect=label1:value1;label2;value2`</mark> | Passing the label and value will result in the form using the label as label and value as value. This can be used for specific cases where the label is not the same as the value. |

{% hint style="warning" %}
**Note:**

* The value has be url encoded.
...
For more information on the Comparative Feature, please follow the article below: [**Initial/Follow-up Form Responses (Comparative)**](form-features-initial-follow-up-form-responses-comparative-form.md)
{% endhint %}
...
<figure><img src="../.gitbook/assets/DOC SF - 1920 x 1080 (5) (1) (1) (1).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/DOC Mobile - 1920 x 1080 (1) (3) (1).png" alt=""><figcaption></figcaption></figure>
