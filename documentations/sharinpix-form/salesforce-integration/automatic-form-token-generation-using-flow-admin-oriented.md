...
Salesforce Admins can streamline their SharinPix Form workflows by automatically generating secure **SharinPix Form Tokens** directly from **Flows**. Once the token is generated, it can be used to dynamically build a [URL](https://app.gitbook.com/s/5EvYRrLbUyvRh8o1jmMG/sharinpix-form/automatic-form-token-generation-using-flow-admin-oriented) that opens the SharinPix Form for users to fill out. This is especially useful in Field Service scenarios, where the [link can launch the SharinPix mobile app directly](https://app.gitbook.com/s/5EvYRrLbUyvRh8o1jmMG/integrations/salesforce-field-service/integration-of-sharinpix-app-with-sfs-fsl-app-using-app-extension).
...
2. Flow Configuration Guide
   * [Step 1: Prepare Custom Field To Store Token](https://app.gitbook.com/s/5EvYRrLbUyvRh8o1jmMG/sharinpix-form/automatic-form-url-generation-using-flow-admin-oriented#step-1-prepare-custom-field-to-store-url)
   * [Step 2: Configure a Record-Triggered Flow](https://app.gitbook.com/s/5EvYRrLbUyvRh8o1jmMG/sharinpix-form/automatic-form-token-generation-using-flow-admin-oriented#step-2-configure-a-record-triggered-flow)
   * [Step 3: Add the Action to Generate the Form Token](https://app.gitbook.com/s/5EvYRrLbUyvRh8o1jmMG/sharinpix-form/automatic-form-token-generation-using-flow-admin-oriented#step-3-add-the-action-to-generate-the-form-token)
   * [Step 4: Add Update Element](automatic-form-token-generation-using-flow-admin-oriented.md#step-4-add-update-element)
   * [Step 5: Save and Activate the Flow](https://app.gitbook.com/s/5EvYRrLbUyvRh8o1jmMG/sharinpix-form/automatic-form-token-generation-using-flow-admin-oriented#step-5-save-and-activate-the-flow)
   * [Step 6: Find the SharinPix Token](https://app.gitbook.com/s/5EvYRrLbUyvRh8o1jmMG/sharinpix-form/automatic-form-token-generation-using-flow-admin-oriented#step-6-find-the-sharinpix-token)
3. [Form Token Use Case Example: Using a Field Service App Extension to Open a SharinPix Form](https://app.gitbook.com/s/5EvYRrLbUyvRh8o1jmMG/sharinpix-form/automatic-form-token-generation-using-flow-admin-oriented#form-token-use-case-example-using-a-field-service-app-extension-to-open-a-sharinpix-form)
...
| formTemplateId   | The ID or Name of the SharinPix Form Template for which you want to generate the token. _(Required)_                                             |
...
<figure><img src="../.gitbook/assets/formimg10.png" alt=""><figcaption></figcaption></figure>

#### TokenAutomation

1. Add an **Action** element
2. Search for <mark style="color:$danger;">`Sharinpix__TokenGeneration`</mark>
3. On the **Action** modal for <mark style="color:$danger;">`Sharinpix__TokenGeneration`</mark>, populate the fields as indicated below:
...
![](<../.gitbook/assets/Flow (1).png>)

### Step 6: Find the SharinPix Token

To test the flow, create or update a **Work Order** record.

After the flow runs, the generated **SharinPix Form Token** will be stored in the <mark style="color:$danger;">`FormToken__c`</mark> field of the Work Order. You can view it directly from the record detail page to confirm that the token was generated successfully.
...
* For more information on how to configure Field Service App Extensions with SharinPix deeplinks/URLs, please refer to [this documentation](https://app.gitbook.com/s/5EvYRrLbUyvRh8o1jmMG/sharinpix-form/integration-of-sharinpix-form-with-sfs-app-using-app-extension).
{% endhint %}
