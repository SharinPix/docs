...
**Assumption:** This guide assumes that the integration of SharinPix Form with the Salesforce Field Service (SFS/FSL) mobile app **is already set up** in your org (App Extension, token field, etc.). If you still need to do that setup, follow this guide first: [_Integration of SharinPix Form with SFS (FSL) App using App Extension_](integration-of-sharinpix-form-with-sfs-app-using-app-extension.md)
{% endhint %}
...
![](<../.gitbook/assets/DOC Mobile - 1920 x 1080 (1) (1) (1) (2).png>)
