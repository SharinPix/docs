...
**https://app.sharinpix.com/native\_app/form?token=**_**< sharinpix-form-token>&**_**< parameter1>=&=&....**
...
You can generate this token using the link below: [Generate Token for a Form](automatic-form-token-generation-using-flow-admin-oriented.md)
...
[<mark style="color:red;">`https://app.sharinpix.com/native_app/form?token=<sharinpix-form-token>&form=formTemplateURL1`</mark>](https://app.sharinpix.com/native_app/form?token=%3Csharinpix-form-token%3E\&form=formTemplateURL1)\
...
1. **Set up in Form Builder**\
   The [_prefill configuration must first be defined within the **SharinPix Form Builder**_](form-features-default-or-prefill-values.md).
...
{% hint style="info" %}
**Info:**\
For more information on the Prefill Feature, please follow the article below: [_**Default or Prefill Values**_](form-features-default-or-prefill-values.md)
{% endhint %}
...
[<mark style="color:$danger;">`https://app.sharinpix.com/native_app/form?token=<`</mark>](https://app.sharinpix.com/native_app/form?token=%3C)<mark style="color:$danger;">`Your Form Token > &ref_response_url=latestFormResponse`</mark>

{% hint style="info" %}
**Info:**\
For more information on the Comparative Feature, please follow the article below: [_**Initial/Follow-up Form Responses (Comparative)**_](form-features-initial-follow-up-form-responses-comparative-form.md)
{% endhint %}
...
[<mark style="color:$danger;">`https://app.sharinpix.com/native_app/form?token=<`</mark>](https://app.sharinpix.com/native_app/form?token=%3C)<mark style="color:$danger;">`Your Form Token > &form_response_url=latestFormResponse`</mark>

{% hint style="info" %}
**Info:**\
For more information on the Relaunch Feature, please follow the article below: [_**Reopen A Previously Submitted SharinPix Form Using URL Parameters**_](reopen-a-previously-submitted-sharinpix-form.md#reopen-a-previously-submitted-sharinpix-form-using-url-parameters)
{% endhint %}
