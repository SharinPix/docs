...
1. [By using a Rollup Helper from the AppExchange.](how-can-i-calculate-the-number-of-images-in-a-sharinpix-album-and-store-the-count-in-a-salesforce-fi.md#using-a-rollup-helper)
2. [Or by using a Salesforce Flow to update the count and the Salesforce field.](how-can-i-calculate-the-number-of-images-in-a-sharinpix-album-and-store-the-count-in-a-salesforce-fi.md#using-a-flow)
...
* After clicking on _Create_, _the Configure Start_ modal will be displayed. Fill in the modal as indicated below:
...
* Click **Done** to save the _formula_ and the _Update Triggering Record_ element.
...
<mark style="color:$danger;">`{!$Record.sharinpix__Account__r.Image_Count__c}-1`</mark>
...
<mark style="color:$danger;">`[sharinpix__SharinPixImage__c].sharinpix__Account__r.Image_Count__c + 1`</mark>
